...
| Achievement | Detail |
|-------------|--------|
| 🥇 **NFSU CTF 2023** | Rank **#9** — MVP **#5** |
| 🥈 **NFSU CTF 2022** | Rank **#28** — MVP **#7** |
| 🐛 **Bug Reports** | 3× Responsibly Disclosed |
| 🔧 **Tools Built** | 5+ Cybersecurity Tools |
| 🌐 **Coverage** | Tested on 100+ URLs |
...
| **Tools** | Nmap · Wireshark · Burp Suite · OWASP ZAP · Metasploit · Gobuster · SQLMap · Hydra |
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&height=80&section=footer&color=00FF3C&fontColor=FFD700&style=neon" width="100%"/>
</p>
